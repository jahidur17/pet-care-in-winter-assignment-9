  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg mt-10 mb-10">
      ...
      <ul className="list-decimal list-inside text-gray-700 space-y-1">
        ...
        <li>To send important updates or pet care tips (with your consent).</li>
      ...
      <p className="text-gray-700 mb-4">
        ...
        third parties. However, we may share limited information if required by
        law.
      </p>
      ...
      <ul className="list-decimal list-inside text-gray-700 space-y-1">
        ...
        <li>You can unsubscribe from email notifications whenever you want.</li>
      </ul>
